...
Security fixes are provided for the latest major version of Semantic Glossary.
...
[private vulnerability reporting](https://github.com/SemanticMediaWiki/SemanticGlossary/security/advisories/new).
...
Semantic Glossary is an extension to MediaWiki that builds on Semantic MediaWiki.
If the issue is actually in one of those rather than in Semantic Glossary itself,
