...
function installToMediaWikiRoot {
	...
	if [ "$SG" != "" ]
	then
		composer require 'mediawiki/semantic-glossary='$SG --prefer-source --update-with-dependencies
	else
		composer init --stability dev
		composer require mediawiki/semantic-glossary "dev-master" --prefer-source --dev --update-with-dependencies
